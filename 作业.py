...
numy = (10 + 69 + 140 + 10 + 10)
numn = (60 + 72 + 35 + 90 + 60 + 60 + 140)
numf = (43 + 25 + 43 + 60 + 43 + 78)
nump = (63 + 24 + +63 + 57)
numt = (63 + 45 + 129 + 63 + 58 + 48 + 63)
numc = (120)
print("总销售额",253.6*numy+86.3*numn+96.8*numf+135.9*nump+65.8*numt+49.3*numc)
print("平均每日销售数量",int((numy+numn+numf+nump+numt+numc)/30))
print("羽绒服的销售量占比",round(numy/(numy+numn+numf+nump+numt+numc)*100,2),"%")
print("牛仔裤的销售量占比",round(numn/(numy+numn+numf+nump+numt+numc)*100,2),"%")
print("风衣的销售量占比",round(numf/(numy+numn+numf+nump+numt+numc)*100,2),"%")
print("皮草的销售量占比",round(nump/(numy+numn+numf+nump+numt+numc)*100,2),"%")
print("T恤的销售量占比",round(numt/(numy+numn+numf+nump+numt+numc)*100,2),"%")
print("衬衫的销售量占比",round(numc/(numy+numn+numf+nump+numt+numc)*100,2),"%")
